  ...
  return (
    <div className="card bg-base-100 shadow">
      <div className="card-body space-y-4">
        <h2 className="font-semibold">Bagikan Undangan</h2>
        ...
        <div className="flex flex-col items-center gap-2 pt-2">
          <p className="text-xs text-base-content/60">QR Code Undangan</p>
          <div className="border border-base-300 rounded-xl p-2 bg-white">
            <Image
              src={qrUrl}
              alt="QR Code"
              width={160}
