      ...
      <div className="card bg-base-100 shadow">
        <div className="card-body space-y-4">
          ...
          <div className="form-control">
            ...
            <input id="venue_name" {...register('venue_name')} type="text"
              placeholder="Contoh: Gedung Serbaguna XYZ" className="input input-bordered" />
          </div>
          ...
          <div className="form-control">
            ...
            <textarea id="venue_address" {...register('venue_address')}
              placeholder="Alamat lengkap venue..." className="textarea textarea-bordered" rows={2} />
          </div>
          ...
          <div className="form-control">
            ...
            <input id="venue_maps_url" {...register('venue_maps_url')} type="url"
              placeholder="https://maps.google.com/..." className="input input-bordered" />
          </div>
        </div>
      </div>
      ...
      <div className="card bg-base-100 shadow">
        <div className="card-body">
          ...
          <p className="text-sm text-base-content/60 mb-2">
            {isEdit ? 'Mengubah slug akan memutus link lama yang sudah dibagikan.' : 'Otomatis diisi dari nama — bisa diubah manual.'}
          </p>
