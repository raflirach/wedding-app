...
export async function createWedding(data: WeddingFormData): Promise<WeddingActionResult> {
  ...
  const { data: wedding, error } = await supabase
    ...
    .insert({
      ...
      bride_father_name: result.data.bride_father_name || null,
      bride_mother_name: result.data.bride_mother_name || null,
      groom_father_name: result.data.groom_father_name || null,
      groom_mother_name: result.data.groom_mother_name || null,
      bride_photo_url: result.data.bride_photo_url || null,
      groom_photo_url: result.data.groom_photo_url || null,
      opening_text: result.data.opening_text || null,
      music_url: result.data.music_url || null,
      akad_date: result.data.akad_date || null,
      akad_time: result.data.akad_time || null,
      akad_venue_name: result.data.akad_venue_name || null,
      akad_venue_address: result.data.akad_venue_address || null,
      akad_venue_maps_url: result.data.akad_venue_maps_url || null,
